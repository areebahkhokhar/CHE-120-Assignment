...
def mainGame(movementInfo):
    global wholecount,maxscore,agent,count
    ...
    while True:
        ...
        state = getstate(lowerPipes,pipew,playerx,playery,playerw,playerh)
        ######################
...
def getstate(lowerPipes,pipew,playerx,playery,playerw,playerh):
    pipe = None
